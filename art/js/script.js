...
var alogForm = document.getElementById("adminloginform");
var remLog = document.getElementById("removeLog");
var remReg = document.getElementById("removeReg");
var aremReg = document.getElementById("adminlog");
function login() {
    remLog.style.display = "none";
    remReg.style.display = "block";
    aremReg.style.display = "block";
    alogForm.style.display = 'none';
...
function adminlogin(){
    alogForm.style.display = "flex"; // Show admin login form
    aremReg.style.display = "none";
    regForm.style.display = "none";
    logForm.style.display = "none";
}
